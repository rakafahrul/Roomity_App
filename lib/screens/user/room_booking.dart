...
//                     // Pastikan semua field user yang diperlukan ada
...
//                     // Pastikan password dan photo tidak null
...
//                     // Buat objek booking dengan semua field yang diperlukan
...
//                       purpose: _activityController.text,
//                       status: 'pending',
//                       checkinTime: null,
//                       checkoutTime: null,
//                       locationGps: '',
//                       isPresent: false,
//                       roomPhotoUrl: widget.roomPhotoUrl ?? '', // Pastikan tidak null
//                       photos: [], // Tambahkan photos array kosong
//                     );

//                     // Pastikan user memiliki password
//                     if (user['password'] == null || user['password'].isEmpty) {
//                       user['password'] = ''; // Default empty string jika null
//                     }

//                     // Pastikan room memiliki semua field yang diperlukan
//                     final room = {
//                       'id': widget.roomId,
//                       'name': widget.roomName,
//                       'capacity': widget.roomCapacity,
//                       'location': widget.roomLocation,
//                       'description': widget.roomDescription,
//                       'photoUrl': widget.roomPhotoUrl ?? '', // Pastikan tidak null
//                       'createdAt': widget.roomCreatedAt?.toIso8601String() ?? DateTime.now().toIso8601String(),
//                       'roomFacilities': [], // Array kosong untuk memenuhi persyaratan API
//                       'bookings': [], // Array kosong untuk memenuhi persyaratan API
//                     };

//                     // Tampilkan loading indicator
//                     setState(() => _isLoading = true);
                    
//                     bool success = await ApiService.createBooking(booking, user, room);
...
class _RoomBookingScreenState extends State<RoomBookingScreen> {
  ...
  Future<void> _handleBooking() async {
    try {
      ...
      // Validasi user dan form seperti sebelumnya...
  ...
  // Future<void> _handleBookingSimple() async {
  //   try {
  //     final prefs = await SharedPreferences.getInstance();
  //     final userJson = prefs.getString('user_data');
  //     if (userJson == null) {
  ...
  //       "LocationGps": "",
  //       "IsPresent": false,
  //       "RoomPhotoUrl": widget.roomPhotoUrl,
  //       "CreatedAt": DateTime.now().toIso8601String(),
  //       "Photos": []
  //     };

  //     final response = await ApiService.createBookingSimple(bookingData);
